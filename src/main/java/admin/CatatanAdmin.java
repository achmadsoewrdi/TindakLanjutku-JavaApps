...
private void hapusCatatan(String idCatatan) {
    ...
    private void initComponents() {
        ...
        teksCatatan = new javax.swing.JTextArea();
        ...
        cardCatatan.setRoundBottomLeft(16);
        cardCatatan.setRoundBottomRight(16);
        cardCatatan.setRoundTopLeft(16);
        cardCatatan.setRoundTopRight(16);

        teksCatatan.setBackground(new java.awt.Color(153, 153, 255));
        teksCatatan.setColumns(20);
        teksCatatan.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        teksCatatan.setForeground(new java.awt.Color(51, 51, 51));
        teksCatatan.setRows(5);
        jScrollPane2.setViewportView(teksCatatan);

        labelPengirim.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        labelPengirim.setForeground(new java.awt.Color(255, 255, 255));
        labelPengirim.setText("Perngirim:");

        nama.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        nama.setForeground(new java.awt.Color(255, 255, 255));
        nama.setText("Nama");

        labelTanggal.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        labelTanggal.setForeground(new java.awt.Color(255, 255, 255));
        labelTanggal.setText("Tanggal   :");

        tugas.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        tugas.setForeground(new java.awt.Color(255, 255, 255));
        tugas.setText("namaTugas");
        ...
        tanggal.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        cardCatatanLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, cardCatatanLayout.createSequentialGroup()
                .addContainerGap(37, Short.MAX_VALUE)
                .addGroup(cardCatatanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(cardCatatanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(cardCatatanLayout.createSequentialGroup()
        ...
        cardCatatanLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, cardCatatanLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(cardCatatanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelPengirim)
                    .addComponent(nama))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private javax.swing.JTextArea teksCatatan;
